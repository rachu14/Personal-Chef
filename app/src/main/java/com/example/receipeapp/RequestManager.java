...
import com.example.receipeapp.Listeners.InstructionListener;
import com.example.receipeapp.Listeners.RandomRecipeResponseListener;
import com.example.receipeapp.Listeners.RecipeDetailsListener;
import com.example.receipeapp.Listeners.SimilarRecipesListener;
...
public class RequestManager {
    ...
    public void getRandomRecipe(RandomRecipeResponseListener listener,List<String > tags){
        CallRandomReceipes callRandomReceipes = retrofit.create(CallRandomReceipes.class);
        Call<RandomRecipeApiResponse> call=callRandomReceipes.callRandomRecipe(context.getString(R.string.api_key),"10", tags);
    ...
    private interface CallRandomReceipes{
        @GET("recipes/random")
